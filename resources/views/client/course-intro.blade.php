        ...
        <div class="container p-0">
            ...
            <div class="bg-blue-600 md:rounded-b-lg md:-mt-8 md:pb-8 md:pt-12 p-8 relative overflow-hidden"
                ...
                <div class="lg:w-9/12 relative z-10">
                    ...
                    <div class="uppercase text-gray-200 mb-2 font-semibold text-sm">{{ $data -> CourseName }}</div>
                    <h1 class="lg:leading-10 lg:text-3xl text-white text-2xl leading-8 font-semibold">{{ $data -> CourseSubTitle }}</h1>
                    <p class="lg:text-lg hidden"> Master JavaScript with the most complete course! Projects Excellent
                        course.
                        we explain the core concepts in javascript that are usually glossed over in other courses </p>
                    <ul class="flex text-gray-200 gap-4 mt-4 mb-2">
                        ...
                        <li>
                            <ion-icon name="people-circle-outline"></ion-icon> {{ $data -> RegisterCount }} Register
                        </li>
                    </ul>
                    <ul class="lg:flex items-center text-gray-200">
                        ...
                        <li> Last updated {{ $data ->updated_at }}</li>
                    </ul>
                    ...
                    <div class="tube-card z-20 mb-4 overflow-hidden uk-sticky"
                        ...
                        <nav class="cd-secondary-nav extanded ppercase nav-small">
                            <ul class="space-x-3" uk-scrollspy-nav="closest: li; scroll: true">
                                ...
                                <li><a href="#curriculum" uk-scroll>Lessons</a></li>
...
{{--                            </div>--}}
{{--                            <div>--}}
{{--                                <h3 class="font-medium text-lg mb-2"> Here is exactly what we cover in this course:--}}
{{--                                </h3>--}}
...
{{--                                    lobortis nisl ut aliquip ex ea commodo consequat. Nam liber tempor cum soluta nobis--}}
...
{{--                            </div>--}}
                    ...
                    <!-- course Curriculum -->
                    <div id="curriculum">
                        <h3 class="mb-4 text-xl font-semibold"> Lessons Curriculum </h3>
                        <ul uk-accordion="multiple: true" class="tube-card p-4 divide-y space-y-3">
                            @if($data->chapters()->count() == 0)
                                <li class="pt-2" style="color:red; font-weight: bold">No chapter in here, we will update soon</li>
                            @endif
                            @foreach($chapters = $data->chapters()->orderBy('SortNumber', 'asc')->get() as $chapter)

                                <li class="pt-2">
                                    <a class="uk-accordion-title text-md mx-2 font-semibold" href="#">
                                        {{ $chapter ->SortNumber }}: {{ $chapter ->ChapterName }}
                                        <div
                                            class="mb-1 text-sm font-medium">
                                            {{ $chapter ->ChapterLessonCount }}
                                            Lesson
                                        </div>
                                    </a>
                                    <div class="uk-accordion-content mt-3 text-base">
                                        @if($chapter->lessons()->count() == 0)
                                            <span style="color: red" class="hover:bg-gray-200 p-2 flex rounded">
                                                Lesson Empty, we will add it soon
                                            </span>
                                        @endif
                                        <ul class="course-curriculum-list font-medium">
                                            @foreach( $lessons = $chapter -> lessons()->where('status', 1)->orderBy('SortNumber', 'asc')->get() as $lesson)
                                                <li class="hover:bg-gray-200 p-2 flex rounded">
                                                    <ion-icon name="play-circle" class="text-2xl mr-2"></ion-icon>
                                                        <a @if($lesson->videos()->count() == 0 && $lesson->practices()->count() == 0) class="disable-link" @endif href="{{ route('lesson-learn', $lesson->id) }}">
                                                        {{ $lesson ->SortNumber }}: {{ $lesson->LessonName }}
                                                    </a>
...
{{--                                <a class="uk-accordion-title font-semibold text-base" href="#"> Html Introduction--}}
{{--                                </a>--}}
{{--                                <div class="uk-accordion-content mt-3">--}}
{{--                                    <p> The primary goal of this quick start guide is to introduce you to Unreal Engine--}}
{{--                                        4`s--}}
{{--                                        (UE4) development environment. By the end of this guide, you`ll know how to set--}}
{{--                                        up--}}
{{--                                        and develop C++ Projects in UE4. This guide--}}
{{--                                        shows you how to create a new Unreal Engine project, add a new C++ class to it,--}}
{{--                                        compile the project, and add an instance of a new class to your level. By the--}}
{{--                                        time--}}
{{--                                        you reach the end of this guide, you`ll be able--}}
{{--                                        to see your programmed Actor floating above a table in the level. </p>--}}
{{--                                </div>--}}
{{--                            </li>--}}
{{--                            <li class="bg-gray-100 px-4 py-3 rounded-md">--}}
{{--                                <a class="uk-accordion-title font-semibold text-base" href="#"> Your First--}}
{{--                                    webpage</a>--}}
{{--                                <div class="uk-accordion-content mt-3">--}}
{{--                                    <p> The primary goal of this quick start guide is to introduce you to Unreal Engine--}}
{{--                                        4`s--}}
...
{{--                            </li>--}}
{{--                            <li class="bg-gray-100 px-4 py-3 rounded-md">--}}
{{--                                <a class="uk-accordion-title font-semibold text-base" href="#"> Some Special Tags--}}
{{--                                </a>--}}
{{--                                <div class="uk-accordion-content mt-3">--}}
{{--                                    <p> The primary goal of this quick start guide is to introduce you to Unreal Engine--}}
{{--                                        4`s--}}
...
{{--                            lobortis nisl ut aliquip ex ea commodo consequat. Nam liber tempor cum soluta nobis eleifend--}}
...
{{--                    </div>--}}
                    ...
                    <div id="reviews" class="tube-card p-5">
                        ...
                        <div class="space-y-4 my-5">
                            ...
                            <div class="bg-gray-50 border flex gap-x-4 p-4 relative rounded-md">
                                ...
                                <div>
                                    ...
                                    <p class="mt-3 md:ml-0 -ml-16">
                                        elit, sed diam ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad
                                        minim
                        ...
                        <div class="flex justify-center mt-9">
                            <a href="#"
                               class="bg-gray-50 border hover:bg-gray-100 px-4 py-1.5 rounded-full text-sm">More
                                Comments ..</a>
                        </div>
                ...
                <div class="lg:w-4/12 space-y-4 lg:mt-0 mt-4">
                    ...
                    <div uk-sticky="top:600;offset:; offset:90 ; media: 1024">
                        <div class="tube-card p-5" uk-sticky="top:600;offset:; offset:90 ; media: @s">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="flex flex-col space-y-2">
                                    <div class="text-3xl font-semibold">{{ $data -> TimeLessonTotal }}</div>
                                    <div> Hours</div>
                                    <ion-icon name="time" class="text-lg" hidden></ion-icon>
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <div class="text-3xl font-semibold">{{ $data -> RegisterCount }}</div>
                                    <div> Students</div>
                        ...
                        <div class="mt-4">
                            ...
                            <a href="#"
                            class="flex items-center justify-center h-9 px-6 rounded-md bg-red-600 text-white">
                             Inactive</a>
                            @else
                            <a href="{{ check_user_has_course($data->id) ? route('lesson-learn',['id'=>$data->chapters->first()->lessons->first()->id]) : route('checkout',["id"=>$data->id]) }}"
                                class="flex items-center justify-center h-9 px-6 rounded-md bg-blue-600 text-white">
                                 {{ $userCourse == 0 ? "Buy Now" : "Start Now" }} </a>
                            @endif
                        </div>
