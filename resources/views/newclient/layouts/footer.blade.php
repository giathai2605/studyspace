                        ...
                        <div class="footer-contact-info">
                            ...
                            <p>
                                ...
                                <a href="https://dreamslms.dreamstechnologies.com/cdn-cgi/l/email-protection"
                                   class="__cf_email__" data-cfemail="42263027232f312e2f3102273a232f322e276c212d2f">[email&#160;đã
                                    được bảo vệ]</a>
                            </p>
                            <p class="mb-0">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="privacy-policy">
                            <ul>
                                <li><a href="{{ route('term-condition') }}">Điều khoản</a></li>
                                <li><a href="{{ route('privacy-policy') }}">Chính sách</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="copyright-text">
                            <p class="mb-0">&copy; Study Space. Yêu tất cả các bạn <img
                                    src="{{asset('img/icon/wish.svg')}}" alt="img"></p>
                        </div>
                    </div>
                </div>
            </div>
