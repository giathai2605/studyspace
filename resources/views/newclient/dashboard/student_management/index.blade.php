                ...
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user1.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Wade Warren</a></h5>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user3.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Dianna Smiley</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>Tunisia</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user2.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Esther Howard</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>Spain</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Guy Hawkins</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>United States</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user6.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Jacob Jones</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>United Kingdom</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user4.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Kristin Watson</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>Iceland</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user11.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Rivao Luke</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>Brazil</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user12.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Nia Sikhone</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>Italy</p>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
            <div class="student-box flex-fill">
                <div class="student-box-blks">
                    <div class="student-img">
                        <a href="student-profile.html">
                            <img class="img-fluid" alt="Students Info" src="{{asset('img/user/user13.jpg')}}">
                        </a>
                    </div>
                    <div class="student-content pb-0">
                        <h5><a href="student-profile.html">Xiaon Merry</a></h5>
                        <div class="loc-blk d-flex align-items-center justify-content-center">
                            <i class="feather-map-pin me-2"></i>
                            <p>France</p>
                        </div>
