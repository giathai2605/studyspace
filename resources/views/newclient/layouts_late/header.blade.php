                        ...
                        <li class="nav-item user-nav">
                            ...
                            <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end"
                                ...
                                <a class="dropdown-item" href="{{ route('home') }}">
                                     Trang chủ</a>
                                <a class="dropdown-item" href="{{ route('client.dashboard.index') }}"></i> Bảng điều khiển</a>
                                ...
                                @if(Auth::check())
                                    <a class="dropdown-item"
                                       href="{{ route('client.dashboard.edit-profile',['id' => auth() -> user() -> id]) }}">
                                        Chỉnh sửa hồ sơ</a>
                                    <a class="dropdown-item"
                                       href="{{ route('dashboard.courses', auth()->id()) }}">Khóa học của tôi</a>
                                    <a class="dropdown-item"
                                        href="{{ route('users.my-courses') }}">Lịch sử khóa học</a>

                                @endif
                                <a class="dropdown-item"
                                   href="{{ route('wishlist') }}"></i> Danh sách yêu thích</a>
