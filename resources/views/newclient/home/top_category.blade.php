        ...
        <div class="owl-carousel mentoring-course owl-theme aos" data-aos="fade-up">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ asset('img/categories-icon-01.png')}}" alt="">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ asset('img/categories-icon-03.png')}}" alt="">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ asset('img/categories-icon-04.png')}}" alt="">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ asset('img/categories-icon-05.png')}}" alt="">
                        </div>
                        <div class="feature-cont">
            ...
            <div class="feature-box text-center ">
                <div class="feature-bg">
                    <div class="feature-header">
                        <div class="feature-icon">
                            <img src="{{ asset('img/categories-icon-02.png')}}" alt="">
                        </div>
                        <div class="feature-cont">
                            <div class="feature-text">Docker Development</div>
                        </div>
