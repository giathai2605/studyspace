        ...
        <div class="px-4 py-4 md:px-6 md:py-6 xl:px-7.5">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex items-center justify-between">
                        ...
                        <div
                            ...
                            <svg width="26" height="20" viewBox="0 0 26 20" fill="none"
                                ...
                                <defs>
                                    ...
                                    <linearGradient id="paint1_linear_605_15057" x1="23.2853" y1="0"
                                        x2="23.2853" y2="19.6187" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#375AD8" />
                                        <stop offset="0.472727" stop-color="#3C56DD" />
                                        <stop offset="1" stop-color="#2A1A8F" />
                                    </linearGradient>
                                    <linearGradient id="paint2_linear_605_15057" x1="11.7948" y1="0"
                                        x2="11.7948" y2="19.8146" gradientUnits="userSpaceOnUse">
                    ...
                    <span
                        class="rounded bg-meta-3/[0.08] py-1.5 px-2.5 text-sm font-medium text-meta-3">Completed</span>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="rounded bg-primary/[0.08] py-1.5 px-2.5 text-sm font-medium text-primary">Upcoming</span>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="rounded bg-red/[0.08] py-1.5 px-2.5 text-sm font-medium text-red">Canceled</span>
                </div>
            </div>
        </div>
    </div>
