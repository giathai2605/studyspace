                    ...
                    <table class="w-full table-auto">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            @foreach ($practice as $model)
                                <a href="{{ route('testcase.create', $model->id) }}"
                        ...
                        @foreach ($data as $model)
                            <tr>
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 class="text-black dark:text-white">{{ $model->NameFunction }}</h5>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $model->Input }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $model->InputDetail }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $model->ExpectOutput }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $model->SortNumber }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        ...
                                        <a class="hover:text-primary"
                                           href="{{ route('testcase.edit',['id' => $model->id]) }}">
                                        ...
                                        <form class="deleteFormTestcase"
                                              data-redirect="{{ route('testcase.index', $model->PracticeLessonID) }}"
                                              method="POST"
                                              data-url="{{ route('testcase.destroy', $model->id) }}">
                                            @csrf
