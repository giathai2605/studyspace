    ...
    @foreach($practice as $model)
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form style="display: none" id="testcaseFormCreateImport" action="{{ route('testcase.import') }}"
                      data-redirect="{{ route('testcase.index', $model->id) }}"
                      data-url="{{ route('testcase.import') }}"
                      method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="PracticeLessonID" value="{{ $model->id }}" hidden>
                    <div class="p-6.5">
                        <div class="mb-4.5">
                    ...
                    <div class="flex justify-end mb-4 mr-6 gap-3">
                        ...
                        <a type="button" href="{{ route('excel.downloadTestcaseTemplate') }}"
                           class="px-6 py-3 text-white bg-warning rounded-md hover:bg-opacity-90 transition">
                            Tải mẫu
                        </a>
                    </div>
                </form>
                <form id="testcaseFormCreateSimple" data-redirect="{{ route('testcase.index', $model->id) }}"
                      action="{{ route('testcase.store') }}"
                      method="post" data-url="{{ route('testcase.store') }}">
                    @csrf
                    <div class="p-6.5">
                        <div class="mb-4.5">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input name="NameFunction" type="text" placeholder="Nhập tên hàm"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                        </div>
                        <div class="mb-4.5">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input name="Input" type="text" placeholder="Nhập đầu vào"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                        </div>
                        <div class="mb-4.5">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input name="InputDetail" type="text" placeholder="Nhập chi tiết đầu vào"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                        </div>
                        <div class="mb-4.5">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input name="ExpectOutput" type="text" placeholder="Nhập đầu ra mong đợi"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                        </div>
                        <div class="">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input name="SortNumber" min="0" type="number" placeholder="Nhập số thứ tự"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"/>
                        </div>
                        <input type="text" name="PracticeLessonID" value="{{ $model->id }}" hidden>
                    </div>
