                    ...
                    <table class="w-full table-auto">
                        ...
                        @foreach ($lessons as $lesson)
                            <tr>
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <h5 class="text-xs font-medium text-black dark:text-white">{{ $lesson->ChapterName }}</h5>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                ...
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    @if( count_comment_by_lesson($lesson->id)>0)
                                    <a class="text-xs inline-flex px-3 py-1 font-medium rounded-full bg-success bg-opacity-10 text-success" href="{{ route('comments.lesson',['id' => $lesson->id])}}">
                                        {{ count_comment_by_lesson($lesson->id) }} bình luận
                                    </a>
                                    @else
                                      <span class="text-xs whitespace-nowrap inline-flex px-3 py-1 font-medium text-gray-600">
                                        Chưa có bình luận
                                    </span>
                                    @endif
