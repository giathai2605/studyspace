                ...
                <div class="p-6.5">
                        ...
                        <select name="CategoryID" id="CategoryID"
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}"
                                        @if($category->id == $detail->CategoryID) selected @endif disabled>{{ $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full xl:w-1/2">
                            ...
                            <input type="text" name="CourseCode" placeholder="Nhập mã khóa học"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                   value="{{ $detail->CourseCode }}" disabled/>
                        </div>
                        <div class="w-full xl:w-1/2">
                            <label class="mb-2.5 block text-black dark:text-white">
                            ...
                            <input type="text" name="CourseName" placeholder="Nhập tên khóa học"
                                   class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                   value="{{ $detail->CourseName }}" disabled/>
                        </div>
                    </div>
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="CourseSubTitle" placeholder="Nhập tiêu đề phụ khóa học"
                               class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                               value="{{ $detail->CourseSubTitle }}" disabled/>
                    </div>
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="number" name="Discount" placeholder="Nhập khuyến mãi"
                               class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                               value="{{ $detail->Discount }}" disabled/>
                    </div>
                    <div class="mb-4.5">
                        <label class="mb-2.5 block text-black dark:text-white">
                            Ảnh dữ liệu <span class="text-meta-1">*</span>
                        </label>
                        <img width="200px" src="{{ asset($detail->ImageData) }}" alt="{{ $detail->ImageData }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="IntroVideoLink" placeholder="Nhập đường dẫn video mô tả"
                               class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                               value="{{ $detail->IntroVideoLink }}" disabled/>
                    </div>
                </div>
            </form>
                        ...
                        <div class="max-w-full overflow-x-auto">
                            <table class="w-full table-auto">
                                ...
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <a href="{{ route('chapter.createWithCourseId',$detail->id) }}"
                                       class="inline-flex items-center justify-center rounded-md bg-primary py-3 px-8 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                                        Thêm mới
                                    </a>
                                </div>
