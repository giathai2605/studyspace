    ...
    <div class="p-4 sm:p-6 xl:p-7.5">
        <nav>
            <ul class="flex flex-wrap items-center">
                <li>
                    <a class="flex h-8 w-8 items-center justify-center rounded hover:bg-primary hover:text-white"
                        href="#">
                ...
                <li>
                    <a class="flex items-center justify-center rounded py-1.5 px-3 font-medium hover:bg-primary hover:text-white"
                        href="#">1</a>
                </li>
                <li>
                    <a class="flex items-center justify-center rounded py-1.5 px-3 font-medium hover:bg-primary hover:text-white"
                ...
                <li>
                    <a class="flex h-9 w-7.5 items-center justify-center rounded py-1.5 px-3 font-medium hover:bg-primary hover:text-white"
                        href="#">
                        <svg class="fill-current" width="10" height="3" viewBox="0 0 10 3" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
