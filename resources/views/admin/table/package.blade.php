        ...
        <table class="w-full table-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p
                            class="inline-flex px-3 py-1 text-sm font-medium rounded-full bg-danger bg-opacity-10 text-danger">
                            Unpaid
                        </p>
                    </td>
                    <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                ...
                <tr>
                    ...
                    <td class="px-4 py-5">
                        <p
                            class="inline-flex px-3 py-1 text-sm font-medium rounded-full bg-warning bg-opacity-10 text-warning">
                            Pending
                        </p>
                    </td>
                    <td class="px-4 py-5">
