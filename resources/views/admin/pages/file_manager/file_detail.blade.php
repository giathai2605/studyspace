    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
        <div
            ...
            <div class="flex items-center gap-5.5">
                ...
                <div>
                    <p class="text-lg font-medium text-[#9B51E0]">Design</p>
                    <span class="font-medium">17 files</span>
                </div>
            </div>
        ...
        <div
            ...
            <div class="flex items-center gap-5.5">
                ...
                <div>
                    <p class="text-lg font-medium text-[#219653]">Image</p>
                    <span class="font-medium">12 files</span>
                </div>
            </div>
        ...
        <div
            ...
            <div class="flex items-center gap-5.5">
                ...
                <div>
                    <p class="text-lg font-medium text-[#2F80ED]">Music</p>
                    <span class="font-medium">39 files</span>
                </div>
            </div>
        ...
        <div class="flex justify-between px-7.5 py-7">
            <div class="flex items-center gap-5.5">
                ...
                <div>
                    <p class="text-lg font-medium text-[#F2994A]">Docs</p>
                    <span class="font-medium">78 files</span>
                </div>
            </div>
