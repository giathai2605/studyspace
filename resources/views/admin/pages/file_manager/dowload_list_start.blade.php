<div class="col-span-12">
    <div class="rounded-sm border border-stroke bg-white py-3 shadow-default dark:border-strokedark dark:bg-boxdark">
        <div
            ...
            <div class="hidden sm:block sm:w-4/12 xl:w-2/12">
                <p class="font-medium text-black dark:text-white">
                    File size: 455KB
                </p>
            </div>
        ...
        <div
            ...
            <div class="flex items-center gap-5.5 sm:w-5/12 xl:w-3/12">
                <div
                    class="hidden h-14 w-full max-w-14 items-center justify-center rounded-full border border-stroke bg-gray text-black-2 dark:border-strokedark dark:bg-graydark dark:text-white sm:flex">
                    <svg class="fill-current" width="29" height="29" viewBox="0 0 29 29" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <clipPath id="clip0_608_18042">
                                <rect width="27.7685" height="27.7685" fill="white"
