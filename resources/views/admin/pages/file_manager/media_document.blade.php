<div
    class="flex-grow rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
    <div class="flex gap-4">
        <div class="flex h-11.5 w-11.5 items-center justify-center rounded-md bg-[#F6F6F8] dark:bg-graydark">
            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <clipPath id="clip0_608_17998">
                        <rect width="23.1404" height="23.1404" fill="white"
        ...
        <div class="flex-grow">
            <div class="mb-3 flex items-center justify-between">
                <span class="font-medium text-black dark:text-white">Media</span>
                <span class="text-sm font-medium">85 GB</span>
            </div>

            <div class="relative h-1.5 w-full rounded-full bg-stroke dark:bg-strokedark">
                <span class="absolute left-0 block h-1.5 w-5/6 rounded-full bg-primary"></span>
            </div>
        </div>
    </div>
    ...
    <div class="mt-5 flex gap-4">
        ...
        <div class="flex-grow">
            <div class="mb-3 flex items-center justify-between">
                <span class="font-medium text-black dark:text-white">Documents</span>
                <span class="text-sm font-medium">25 GB</span>
            </div>

            <div class="relative h-1.5 w-full rounded-full bg-stroke dark:bg-strokedark">
                <span class="absolute left-0 block h-1.5 w-1/2 rounded-full bg-[#F2994A]"></span>
            </div>
        </div>
    </div>
</div>
