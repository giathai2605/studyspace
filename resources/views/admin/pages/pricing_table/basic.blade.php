<div
    ...
    <span class="absolute top-3.5 -right-1"><img src="src/images/best-value-banner.png" alt="Banner" /></span>
    <span class="mb-2.5 block text-title-sm2 font-bold text-black dark:text-white">Basic</span>
    <h3>
    ...
    <h4 class="mt-7.5 mb-5 text-lg font-medium text-black dark:text-white">
        Features
    </h4>
    ...
    <button
        class="mt-9 flex rounded-md border border-primary py-3 px-9 font-medium text-primary hover:bg-primary hover:text-white">
        Purchase Now
    </button>
</div>
