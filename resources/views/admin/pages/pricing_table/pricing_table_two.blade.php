        ...
        <table class="table-auto">
                ...
                <tr>
                    ...
                    <th class="w-1/4 min-w-[200px] px-5">
                        <div class="mb-10 text-left">
                            <span class="mb-3.5 block text-xl font-bold text-black dark:text-white">
                                Starter
                            </span>
                            <h4 class="mb-4">
                                <span class="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$59</span>
                    ...
                    <th class="w-1/4 min-w-[200px] px-5">
                        <div class="mb-10 text-left">
                            ...
                            <h4 class="mb-4">
                                <span class="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$99</span>
                                <span class="font-medium">Per Month</span>
                            </h4>
                    ...
                    <th class="w-1/4 min-w-[200px] px-5">
                        <div class="mb-10 text-left">
                            ...
                            <h4 class="mb-4">
                                <span
                                    class="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$149</span>
                                <span class="font-medium">Per Month</span>
                            </h4>
                            <p class="mb-6 font-medium">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-t border-stroke py-5 px-7 dark:border-strokedark">
                        <h5 class="text-center font-medium text-black dark:text-white">
                            Features Limits
                        </h5>
                    </td>
                    <td class="border-t border-stroke py-5 px-7 dark:border-strokedark">
