    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        >
            <div class="mx-auto max-w-[490px]">
                <img
                        src="src/images/illustration/illustration-02.svg"
                        alt="illustration"
                />
                ...
                <div class="mt-7.5 text-center">
                    ...
                    <p class="font-medium">
                        Thank you so much for your message. We check e-mail
                        frequently and will try our best to respond to your inquiry.
                    </p>
                    <a
                            href="index.html"
