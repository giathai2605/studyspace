                            ...
                            <tr>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <div class="flex gap-4">
                                        @if($model->avatar != '')
                                            <img src="{{ asset($model->avatar) }}" class="rounded-full"
                                ...
                                {{--                                        <input type="checkbox" onchange="update_user_status(this)" value="{{ $model->id }}" {{ $model->userStatusID == 1 ? 'checked' : '' }} disabled>--}}
                                {{--                                        <span></span>--}}
                                {{--                                    </label>--}}
                                {{--                                </td>--}}
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <a class="hover:text-primary"
                                           href="{{ route('users.profile',['id' => $model->id]) }}">
                                        ...
                                        @endcan
                                        @can('users.destroy-admin')
                                            <form class="deleteFormUser" data-redirect="{{ route('users.admin') }}"
                                                  method="POST"
