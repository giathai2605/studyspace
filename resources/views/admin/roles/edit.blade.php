...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form data-redirect="{{ route('roles.index') }}" id="roleFormEdit"
                ...
                <div class="grid gap-5.5 p-6.5">
                    <div>
                        ...
                        <input type="text" placeholder="Tên vai trò" name="name"
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full text-center" style="padding: 5px">
                                ...
                                <label for="selectAll" class="text-red" style="font-weight: bold">Chọn / Bỏ chọn tất cả</label> --}}
