                        ...
                        @foreach ($roles as $role)
                            <tr>
                                <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 class="text-black dark:text-white">{{ $role->name }}</h5>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p class="text-black dark:text-white">{{ $role->guard_name }}</p>
                                </td>
                                <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        <a class="hover:text-primary"
                                           href="{{ route('roles.show',['id' => $role->id]) }}">
                                        ...
                                        @can('users.destroy-admin')
                                            <form class="deleteFormRole" data-redirect="{{ route('roles.index') }}"
                                                  method="POST"
