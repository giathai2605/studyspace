    ...
    passwordInput.oninput= function(){
		...
		if(passwordValue != ""){
			...
			if(whitespace)
			{
				...
				passwordInfo.textContent = "Không được có khoảng trắng!";
			}
			else {
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength < 8)
			{
			   ...
			   passwordInfo.style.display = "block";
			   passwordInfo.style.color = "#FF0000";
			   passwordInfo.innerHTML  = "<span>&#128545;</span>" + " " + "Yếu! Phải chứa ít nhất 8 ký tự.";
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength >= 8 && (poorPassword || weakPassword || strongPassword))
			{
			   ...
			   passwordInfo.innerHTML = "<span>&#128547;</span>" + "Trung bình! Phải chứa ít nhất 1 chữ cái hoặc số.";
		   ...
		   if(passwordLength>= 8 && poorPassword && (weakPassword || strongPassword))
			{
			 ...
			 passwordStrength.classList.remove("heavy-active");
			 passwordInfo.innerHTML = "<span>&#128522;</span>" + "Mạnh! Phải chứa ký hiệu đặc biệt.";
		  ...
		  if(passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword)
			{
			 ...
			 passwordInfo.innerHTML = "<span>&#128525;</span>" + "Tuyệt vời! Bạn có một mật khẩu an toàn.";
